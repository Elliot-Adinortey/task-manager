...
var TaskController = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.taskService.getAllTasks()];
                    case 1:
                        tasks = _a.sent();
                        res.json(tasks);
                        return [3 /*break*/, 3];
    ...
    TaskController.prototype.createTask = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, title, description, completed, newTask, error_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.body, title = _a.title, description = _a.description, completed = _a.completed;
                        return [4 /*yield*/, this.taskService.createTask({ title: title, description: description, completed: completed })];
                    case 1:
                        newTask = _b.sent();
    ...
    TaskController.prototype.updateTask = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var taskId, _a, title, description, completed, updatedTask, error_4;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        taskId = req.params.id;
                        _a = req.body, title = _a.title, description = _a.description, completed = _a.completed;
                        return [4 /*yield*/, this.taskService.updateTask(taskId, { title: title, description: description, completed: completed })];
                    case 1:
                        updatedTask = _b.sent();
                        if (!updatedTask) {
                            return [2 /*return*/, res.status(404).json({ error: 'Task not found' })];
    ...
    TaskController.prototype.deleteTask = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var taskId, deletedTask, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        taskId = req.params.id;
                        return [4 /*yield*/, this.taskService.deleteTask(taskId)];
                    case 1:
                        deletedTask = _a.sent();
                        if (!deletedTask) {
                            return [2 /*return*/, res.status(404).json({ error: 'Task not found' })];
